...
from tutoring_app.database import get_db, TutorProfile, pwd_context, UserRole  # Added UserRole import
from tutoring_app.models import TutorProfileResponse, TutorProfileCreate  # Also add TutorProfileCreate import
from tutoring_app.authentication import tutor_only, require_roles, limiter
